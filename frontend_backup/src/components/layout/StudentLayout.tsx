...
const NAV = [
  { to: '/student/overview',  icon: '🏠', label: 'Overview' },
  { to: '/student/reserve',   icon: '🎫', label: 'Reserve' },
    ...
    <div style={{
      ...
      <aside style={{
        ...
        <nav style={{ flex: 1, padding: '8px 10px', display: 'flex', flexDirection: 'column', gap: 2 }}>
          {NAV.map(n => {
            const active = loc.pathname === n.to || (n.to === '/student/overview' && loc.pathname === '/student')
            return (
              <NavLink
                key={n.to}
                to={n.to}
