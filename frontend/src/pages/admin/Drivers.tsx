...
import type { User, Bus } from '../../types/api';
...
const Drivers = () => {
  ...
  const drivers: User[] = []; // TODO: wire to backend driver list
              ...
              <div key={d.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  <div style={{
                    ...
                    {d.login_42.charAt(0).toUpperCase()}
                  </div>
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: V.ink }}>
                      {d.login_42}
                    </div>
                    <div style={{ fontSize: 11, color: V.dim }}>{d.email || 'No email'}</div>
                  </div>
                </div>
