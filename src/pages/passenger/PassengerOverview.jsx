  ...
  return (
    <div style={{ display: "grid", gap: 48 }}>
      <section style={{ position: "relative" }}>
        ...
        >
          <div style={{ padding: 40, display: "grid", gap: 24 }}>
            <div>
              ...
              <h2 style={{ margin: "8px 0 6px", fontSize: 52, lineHeight: 1, letterSpacing: "-0.04em" }}>
                {tonightTrip?.route_name || "Downtown Express"}
              </h2>
          ...
          <div style={{ background: "var(--surface2)", borderLeft: "1px solid var(--line2)", padding: 24, display: "grid", alignContent: "center", gap: 18 }}>
            <div style={{ position: "relative", width: "100%", aspectRatio: "1 / 1", borderRadius: 10, border: "1px solid color-mix(in srgb, var(--line) 15%, transparent)", background: "var(--bg)", overflow: "hidden" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(3,minmax(0,1fr))", gap: "var(--space-4)" }}>
        {[
          { label: "My Stop", value: user?.station_name || "Not set", sub: "ZONE-B4" },
          { label: "This Month", value: String(ridesThisMonth), sub: "+ trend" },
      ...
      <section style={{ display: "grid", gap: 12 }}>
        ...
        <div style={{ display: "grid", gap: 10 }}>
          {reservations.slice(0, 3).map((reservation) => (
            <div key={reservation.id} style={{ border: "1px solid var(--line2)", borderRadius: 10, background: "var(--surface)", padding: "14px 16px", display: "flex", justifyContent: "space-between", gap: 12 }}>
              <div>
